...
public final class JsonApiClientMock: JwtApiClient.JsonApiClient, Mockingbird.Mock {
  ...
  // MARK: Mocked `patch`(`url`: URL, `dictionary`: [String: Any])
  public override func `patch`(`url`: URL, `dictionary`: [String: Any]) async throws -> URLResponse {
    return try await self.mockingbirdContext.mocking.didInvoke(Mockingbird.SwiftInvocation(selectorName: "`patch`(`url`: URL, `dictionary`: [String: Any]) async throws -> URLResponse", selectorType: Mockingbird.SelectorType.method, arguments: [Mockingbird.ArgumentMatcher(`url`), Mockingbird.ArgumentMatcher(`dictionary`)], returnType: Swift.ObjectIdentifier((URLResponse).self))) {
      ...
      for mkbTargetBox in self.mockingbirdContext.proxy.targets(for: $0) {
        ...
        case .super:
          return try await super.`patch`(url: `url`, dictionary: `dictionary`)
        case .object(let mkbObject):
          guard var mkbObject = mkbObject as? MockingbirdSupertype else { break }
          let mkbValue: URLResponse = try await mkbObject.`patch`(url: `url`, dictionary: `dictionary`)
  ...
  public func `patch`(`url`: @autoclosure () -> URL, `dictionary`: @autoclosure () -> [String: Any]) async -> Mockingbird.Mockable<Mockingbird.ThrowingAsyncFunctionDeclaration, (URL, [String: Any]) async throws -> URLResponse, URLResponse> {
    return Mockingbird.Mockable<Mockingbird.ThrowingAsyncFunctionDeclaration, (URL, [String: Any]) async throws -> URLResponse, URLResponse>(context: self.mockingbirdContext, invocation: Mockingbird.SwiftInvocation(selectorName: "`patch`(`url`: URL, `dictionary`: [String: Any]) async throws -> URLResponse", selectorType: Mockingbird.SelectorType.method, arguments: [Mockingbird.resolve(`url`), Mockingbird.resolve(`dictionary`)], returnType: Swift.ObjectIdentifier((URLResponse).self)))
  }
